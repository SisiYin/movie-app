...
const getGroupDetails = async (req, res) => {
  ...
  try {
    ...
    // const groupMember = await isGroupMember(groupId,userId)
...
export {getGroups, createGroup, removeGroup, requestToJoin,getJoinRequests, manageRequest,getGroupDetails,removeMember,editGroupDetails,leaveGroup,getUserGroups,addContentToGroup,getGroupContent,addShowtimeToGroup,getGroupShowtimesContent,upload,uploadGroupImage,getGroupImage}
